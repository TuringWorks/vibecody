...
```bash
curl -LO https://github.com/TuringWorks/vibecody/releases/download/v0.5.8/VibeCody-Wear-v0.5.8.apk
adb connect <watch-ip>:5555          # enable ADB debugging first
adb -s <watch-ip>:5555 install VibeCody-Wear-v0.5.8.apk
```
...
Upload [`VibeCody-Wear-v0.5.8.aab`](https://github.com/TuringWorks/vibecody/releases/download/v0.5.8/VibeCody-Wear-v0.5.8.aab) to the Play Console's internal-testing track. Once approved, install directly from the watch's Play Store.
