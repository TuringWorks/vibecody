...
- **Trace and resume** — Every session can be resumed with `vibecli --resume <id>`
...
- **AI Generate tab** — Describe your UI in natural language, get components
...
- **View Tools navigation** — Click "View Tools" on an installed plugin, scrolls to and highlights its server section
...
- Structured requirements, design, and tasks workflow
...
- **2 new tutorials** — Project Init and Auto-Context, Always-On Channel Daemon
...
See [compare view](https://github.com/TuringWorks/vibecody/compare/v0.3.3...v0.4.0) for the complete diff.
