...
- API keys for at least two AI providers (see [Demo 3: Multi-Provider Chat]({{ site.baseurl }}/demos/multi-provider-chat/))
...
- [Demo 6: Cost Observatory]({{ site.baseurl }}/demos/cost-observatory/) -- Understand the cost of each model you tested
- [Demo 3: Multi-Provider Chat]({{ site.baseurl }}/demos/multi-provider-chat/) -- Deep dive into provider configuration
- [Demo 4: Agent Loop]({{ site.baseurl }}/demos/agent-loop/) -- Compare how different models perform in agent tasks
