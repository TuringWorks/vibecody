...
- [Demo 04: Agent Loop & Tool Execution]({{ site.baseurl }}/demos/agent-loop/) -- Let the AI execute suggested actions
- [Demo 06: Cost Observatory]({{ site.baseurl }}/demos/cost-observatory/) -- Track costs of executed suggestions
