...
- [Demo 20: Agent Teams]({{ site.baseurl }}/demos/agent-teams/) -- Multi-agent collaboration with defined roles
- [Demo 4: Agent Loop]({{ site.baseurl }}/demos/agent-loop/) -- Single-agent autonomous coding
