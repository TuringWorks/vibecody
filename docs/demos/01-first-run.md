...
- [Demo 2: TUI Interface]({{ site.baseurl }}/demos/tui-interface/) -- Learn to navigate the terminal UI
- [Demo 3: Multi-Provider Chat]({{ site.baseurl }}/demos/multi-provider-chat/) -- Switch between 23 AI providers
- [Demo 4: Agent Loop]({{ site.baseurl }}/demos/agent-loop/) -- Let the AI edit files and run commands
