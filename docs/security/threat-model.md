...
| 2026-05-14 | #18 fixed | `docs/connectivity.md` gets a *Security: which bind address to pick* section — comparison table (loopback / Tailscale / LAN / `0.0.0.0`), mental model that mDNS/Tailscale/ngrok are transports, link to key-rotation doc. |
