    ...
    <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 16, fontSize: 13, color: "var(--text-primary)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            <div className="panel-card">
              ...
              <div style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
                <button className="panel-btn panel-btn-primary" style={{ fontSize: 11, padding: "4px 10px" }} onClick={() => runAction("mouse_move", { x: mouseX, y: mouseY })}>Move</button>
                <button className="panel-btn panel-btn-primary" style={{ fontSize: 11, padding: "4px 10px" }} onClick={() => runAction("mouse_click", { x: mouseX, y: mouseY })}>Click</button>
                <button className="panel-btn panel-btn-primary" style={{ fontSize: 11, padding: "4px 10px" }} onClick={() => runAction("mouse_double_click", { x: mouseX, y: mouseY })}>Double-Click</button>
                <button className="panel-btn panel-btn-primary" style={{ fontSize: 11, padding: "4px 10px" }} onClick={() => runAction("mouse_right_click", { x: mouseX, y: mouseY })}>Right-Click</button>
              </div>
            </div>
            ...
            <div className="panel-card">
              ...
              <div style={{ display: "flex", gap: 4, marginBottom: 8 }}>
                <button className="panel-btn panel-btn-primary" style={{ fontSize: 11, padding: "4px 10px" }} onClick={() => runAction("type_text", { text: typeText })}>Type Text</button>
              </div>
              ...
              <button className="panel-btn panel-btn-primary" style={{ fontSize: 11, padding: "4px 10px" }} onClick={() => runAction("key_combo", { combo: keyCombo })}>Press Key Combo</button>
            </div>
          </div>
          ...
          <div className="panel-card" style={{ marginTop: 12 }}>
            ...
            <div style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
              {["screenshot", "get_mouse_position", "get_screen_size", "get_active_window"].map(a => (
                <button key={a} onClick={() => runAction(a, {})} className="panel-btn panel-btn-secondary" style={{ fontSize: 11, padding: "4px 10px" }}>
      ...
      {tab === "windows" && (
        <div>
          ...
          <button className="panel-btn panel-btn-primary" style={{ marginBottom: 12, fontSize: 11 }} onClick={refreshWindows} disabled={loading}>
      ...
      {tab === "macros" && (
        <div>
          ...
          <div className="panel-card" style={{ marginTop: 8, color: "var(--text-secondary)", fontSize: 12, fontStyle: "italic" }}>No saved macros yet.</div>
        </div>
      )}
