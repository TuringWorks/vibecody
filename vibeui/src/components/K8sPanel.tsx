        ...
        {subTab === "manifests" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
              ...
              >
                {manifestLoading ? "⏳ Generating..." : "⚙️ Generate YAML"}
              </button>
              {manifestYaml && (
                <>
                  <button
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            {contexts.length === 0 && (
              <div style={{ fontSize: 12, color: "var(--text-muted)", padding: "10px 0" }}>
                ℹ️ No kubectl contexts found. Install kubectl and configure your kubeconfig, or type a context name manually above.
              </div>
            )}
          </div>
        )}
