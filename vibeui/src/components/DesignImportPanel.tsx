...
const dropZoneStyle: React.CSSProperties = {
  border: "2px dashed var(--border-color)", borderRadius: "var(--radius-sm-alt)", padding: 40, textAlign: "center",
        ...
        {tab === "Import" && (
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
              ...
              <select style={{ padding: "8px 12px", background: "var(--bg-tertiary)", color: "var(--text-primary)", border: "1px solid var(--border-color)", borderRadius: "var(--radius-xs-plus)", fontSize: "var(--font-size-md)", fontFamily: "inherit", minWidth: 140 }} value={framework} onChange={e => setFramework(e.target.value)} aria-label="Select framework">
            ...
            <div style={dropZoneStyle} role="button" aria-label="Drop zone for design files">
              ...
              <div style={{ fontSize: "var(--font-size-base)" }}>PNG, JPG, SVG, or screenshot</div>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <input style={{ flex: 1, width: "100%", padding: "8px 12px", background: "var(--bg-tertiary)", color: "var(--text-primary)", border: "1px solid var(--border-color)", borderRadius: "var(--radius-xs-plus)", fontSize: "var(--font-size-md)", fontFamily: "inherit", boxSizing: "border-box" }} placeholder="Or paste Figma URL..." value={figmaUrl} onChange={e => setFigmaUrl(e.target.value)} aria-label="Figma URL input" />
