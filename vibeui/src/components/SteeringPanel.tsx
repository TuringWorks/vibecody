...
export default function SteeringPanel({ workspaceRoot }: SteeringPanelProps) {
 ...
 <span style={{ color: "var(--text-muted, #6c7086)", fontSize: 11, width: "100%" }}>Choose a template to get started:</span>
 {TEMPLATES.map((tpl) => (
 ...
 {files.length === 0 && (
 <div style={{ color: "var(--text-muted, #6c7086)", fontSize: 12, padding: 8, textAlign: "center" }}>
 ...
 style={{ background: "none", border: "none", color: "var(--text-danger, #f38ba8)", cursor: "pointer", fontSize: 10, padding: "0 2px", lineHeight: 1, fontWeight: 600 }}
 >
 Del
 </button>
 <button
 ...
 title="Cancel"
 style={{ background: "none", border: "none", color: "var(--text-muted, #6c7086)", cursor: "pointer", fontSize: 10, padding: "0 2px", lineHeight: 1 }}
 >
 ✕
 </button>
 </span>
 ...
 title="Delete"
 style={{ background: "none", border: "none", color: "var(--text-muted, #6c7086)", cursor: "pointer", fontSize: 12, padding: "0 2px", lineHeight: 1 }}
 >
 ✕
 </button>
 )}
 ...
 {!editing ? (
 <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", color: "var(--text-muted, #6c7086)", fontSize: 13 }}>
 ...
 <div style={{ color: "var(--text-muted, #6c7086)", fontSize: 11 }}>
