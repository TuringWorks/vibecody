  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1 }} />
        {view !== "setup" && (
          <button onClick={handleReset} style={{ ...btnStyle, color: "#f38ba8" }}>Reset</button>
        )}
      </div>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "8px 12px" }}>
        ...
        {view === "setup" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <button onClick={handleStart} disabled={loading} style={{ ...btnStyle, background: "#6366f1", color: "#fff" }}>
        ...
        {view === "running" && current && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <div style={{
              ...
              background: "var(--bg-primary, #11111b)", border: "1px solid var(--border, #2a2a3e)",
            }}>
              <div style={{ fontSize: 10, fontWeight: 600, opacity: 0.6, marginBottom: 4 }}>Current Commit</div>
              {current.current_commit && (
                <div style={{ fontFamily: "monospace", fontSize: 12, color: "#f9e2af" }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              <button
                ...
                disabled={loading}
                style={{ ...btnStyle, flex: 1, background: "rgba(166,227,161,0.15)", color: "#a6e3a1", fontWeight: 700 }}
              >
                Good
              </button>
              <button
                ...
                disabled={loading}
                style={{ ...btnStyle, flex: 1, background: "rgba(243,139,168,0.15)", color: "#f38ba8", fontWeight: 700 }}
              >
                Bad
              </button>
              <button
            ...
            <div style={{ display: "flex", gap: 6 }}>
              ...
              <button onClick={handleAnalyze} disabled={loading} style={{ ...btnStyle, color: "#89b4fa" }}>
        ...
        {view === "done" && current && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <div style={{
              ...
              <div style={{ fontSize: 13, fontWeight: 700, color: "#f38ba8" }}>Culprit Found!</div>
              <div style={{ fontFamily: "monospace", fontSize: 14, color: "#f9e2af", marginTop: 6 }}>
            ...
            <button onClick={handleReset} style={{ ...btnStyle, color: "#f38ba8" }}>Reset Bisect</button>
          </div>
        )}
      </div>
    </div>
