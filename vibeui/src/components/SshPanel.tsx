...
export function SshPanel({ workspacePath: _ }: SshPanelProps) {
 ...
 border: `1px solid ${selectedId === p.id ? "#6366f1" : "var(--border-color)"}`,
 ...
 border: `1px solid ${result.success ? "#a6e3a1" : "#f38ba8"}`,
 ...
 key={i}
 style={{
 color: line.startsWith("$ ssh") ? "#89b4fa"
 : line.startsWith("[Exit") ? (line.includes("Exit 0") ? "#a6e3a1" : "#f38ba8")
 : "#e6edf3",
 }}
 >
 {line}
 ...
 {running && <div style={{ color: "#89dceb" }}>▌</div>}
 </div>
 )}
