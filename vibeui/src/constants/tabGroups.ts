...
export const TAB_GROUPS: TabGroup[] = [
  ...
  {
    label: "Project",
    tabs: ["agile", "workmanagement", "memory", "specs", "soul", "bundles", "workflow", "orchestration", "design", "steering", "traces", "dashboard", "recording", "demo", "fastcontext", "plandoc", "remotecontrol", "clarify", "codesearch"],
  },
  {
    label: "Code",
  ...
  },
  {
    ...
    tabs: ["deploy", "docker", "k8s", "cicd", "ghactions", "env", "sandbox", "cloudsandbox", "health", "scaffold", "appbuilder", "training", "inference", "cistatus", "fullstack", "cloudproviders", "idp", "quantum"],
  },
  {
    label: "Data & API",
