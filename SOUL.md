...
- **Modular Rust workspace.** `vibe-core` (buffers, FS, Git), `vibe-ai` (23 AI provider backends + failover), `vibe-lsp`, `vibe-extensions` (Wasmtime), and `vibe-collab` (CRDT) are shared crates reused across every Rust artifact.
