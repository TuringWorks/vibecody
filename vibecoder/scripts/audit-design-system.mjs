#!/usr/bin/env node
/**
 * audit-design-system.mjs — scan every panel in vibecoder/src/components/ for
 * violations of the design-system rules documented in vibecoder/design-system/
 * and required by AGENTS.md.
 *
 * Run from vibecoder/:  node scripts/audit-design-system.mjs
...
lines.push("# VibeCoder Design-System Audit");
lines.push("");
lines.push(`_Generated ${today} by \`vibecoder/scripts/audit-design-system.mjs\`._`);
lines.push("");
lines.push(`Scanned **${results.length}** panels in \`vibecoder/src/components/*Panel.tsx\`.`);
lines.push("");
