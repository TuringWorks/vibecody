# VibeCoder Design System

A complete, token-based design system for VibeCoder panels and components. Inspired by Material Design 3, GitHub Primer, and Shopify Polaris. All tokens are CSS custom properties defined in `design-system/tokens.css`. All components are CSS classes, usable with `className` in React/TSX.
