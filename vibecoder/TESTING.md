# VibeCoder Manual Testing Checklist
...
- [x] Header shows "VibeCoder" title
...
- [x] Tip about opening vibeCoder folder is shown
...
1. **Open Folder**
   ...
   - Select `/Users/ravindraboddipalli/sources/git2/vibeCoder`
...
1. **Start the app**:
   ```bash
   cd /Users/ravindraboddipalli/sources/git2/vibeCoder
   npm run tauri dev
   ```
...
![VibeCoder Welcome Screen](file:///Users/ravindraboddipalli/.gemini/antigravity/brain/6c67e30e-8257-46eb-8a23-69b270bcb634/vibecoder_welcome_screen_1764039373821.png)
