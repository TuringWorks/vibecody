//! VibeCoder - AI-Powered Code Editor
#![recursion_limit = "512"]
...
pub fn run() {
    ...
    let config_path = dirs::home_dir()
        .map(|h| h.join(".vibecoder").join("vibe.toml"))
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            let app_submenu = SubmenuBuilder::new(app, "VibeCoder")
                .about(None)
                .separator()
                .hide()
                .hide_others()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::voice_vocab_build,
            commands::voice_vocab_stats,
            commands::voice_vocab_metrics,
            commands::policy_check,
            commands::policy_conflicts,
            commands::long_context_models,
            commands::long_context_route,
            commands::long_context_ingest,
            commands::ide_bridge_status,
            commands::ide_bridge_context,
            commands::ide_bridge_sync,
            commands::auto_deploy_plan,
            commands::auto_deploy_stage_status,
            commands::auto_deploy_history,
            commands::semindex_callgraph,
            commands::design_mode_annotations,
            commands::design_mode_generate,
            commands::design_mode_tokens,
            commands::company_task_move,
            commands::export_pencil_wireframe,
            commands::agile_ai_enhance_safe,
            ...
            commands::read_archive_file,
            commands::read_archive_file_base64,
            commands::plan_archive_extraction,
            commands::extract_archive,
            commands::read_file_sandbox,
            commands::write_file_sandbox,
            commands::create_directory_sandbox,
            commands::delete_path_sandbox,
            commands::rename_path_sandbox,
            commands::get_git_status_for_path,
            ...
            commands::lsp_resolve_completion,
            commands::lsp_language_support,
            commands::lsp_restart_language,
            ...
            commands::get_vibecoder_rules,
            commands::save_vibecoder_rules,
            ...
            commands::soul_read,
            commands::soul_save,
            commands::generate_vibecoder_rules,
            ...
            commands::exec_goal_create,
            commands::exec_goal_list,
            commands::exec_goal_get,
            commands::exec_goal_update,
            commands::exec_goal_delete,
            commands::exec_goal_plan,
            ...
            // kodegraph code-graph surface (/v1/graph/* proxies).
            commands::graph_status,
            commands::graph_build,
            commands::graph_query,
            commands::graph_node,
            commands::graph_neighbors,
            commands::graph_path,
            commands::graph_blast,
