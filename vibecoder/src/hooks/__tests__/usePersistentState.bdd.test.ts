 ...
 *  3. Setting a value persists it to localStorage under the "vibecoder-panel:" prefix
 ...
 *  8. clearAllPanelState removes all "vibecoder-panel:" keys
...
describe('Given a mounted usePersistentState hook', () => {
  ...
  it('When setState is called, Then the key is stored with the "vibecoder-panel:" prefix', () => {
...
describe('Given multiple panel state keys are in localStorage', () => {
  it('When clearAllPanelState is called, Then all "vibecoder-panel:" keys are removed', () => {
