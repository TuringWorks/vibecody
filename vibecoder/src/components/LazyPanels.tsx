...
export function PanelHost(props: PanelHostProps) {
  ...
  return (
    <>
      {/* --- AI --- */}
      {panel("chat", <LazyPanel Component={ChatComposite} props={{ defaultProvider: selectedProvider, availableProviders, context: editorContent, fileTree, currentFile, onPendingWrite, onSwitchToGoals, workspacePath: wp, onOpenFile }} />)}
