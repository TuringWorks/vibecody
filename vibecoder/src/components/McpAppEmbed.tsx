...
//     `vibecoder:mcp-app-action` with `{ action_id, label, props }`. The
...
export function McpAppEmbed({ payload, sourceId }: Props) {
  ...
  function fireAction(action: McpAppAction) {
    window.dispatchEvent(
      new CustomEvent("vibecoder:mcp-app-action", {
        detail: {
        ...
        <>
          {!supported && (
            ...
            >
              ...
              requires a renderer not built into VibeCoder. Props are shown below for
