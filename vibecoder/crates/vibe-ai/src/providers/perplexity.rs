...
impl PerplexityProvider {
    ...
    fn base_url(&self) -> String {
        self.config
            .api_url
            .clone()
            .unwrap_or_else(|| PERPLEXITY_BASE_URL.to_string())
    }
    ...
    fn api_key(&self) -> Result<&str> {
        self.config
            .api_key
            .as_deref()
            .context("Perplexity API key not set (PERPLEXITY_API_KEY)")
    }
    ...
    fn request_sonar_deep_research_model() {
        let req = ChatRequest {
            ...
            messages: vec![
                ChatMessage {
                    role: "system".into(),
                    content: "research thoroughly".into(),
                },
                ChatMessage {
                    role: "user".into(),
                    content: "investigate this".into(),
                },
            ],
