...
description: "Maintenance prediction agent: The Maintenance prediction agent is an AI agent that predicts asset failures and schedules maintenance. Use when the task involves maintenance prediction agent, predicts asset failures, schedules maintenance."
category: energy
triggers: ["maintenance prediction agent", "predicts asset failures", "schedules maintenance"]
