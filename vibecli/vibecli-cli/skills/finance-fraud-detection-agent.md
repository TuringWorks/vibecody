...
description: "Fraud detection agent: The Fraud detection agent is an AI agent that detects fraud patterns across transactions. Use when the task involves fraud detection agent, finance, detects fraud patterns across transactions."
category: finance
triggers: ["fraud detection agent", "finance", "detects fraud patterns across transactions"]
