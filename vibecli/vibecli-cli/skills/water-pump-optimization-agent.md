...
description: "Pump optimization agent: The Pump optimization agent is an AI agent that optimizes pumping and energy use across the network. Use when the task involves pump optimization agent, optimizes pumping, energy use across the network."
category: water
triggers: ["pump optimization agent", "optimizes pumping", "energy use across the network"]
