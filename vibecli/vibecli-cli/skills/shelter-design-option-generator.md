...
description: "Design option generator: The Design option generator is an AI agent that generates and compares design options against constraints. Use when the task involves design option generator, generates, compares design options against constraints."
category: construction
triggers: ["design option generator", "generates", "compares design options against constraints"]
