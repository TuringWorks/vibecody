...
description: "Job description agent: The Job description agent is an AI agent that drafts and calibrates job descriptions and scorecards. Use when the task involves job description agent, drafts, calibrates job descriptions, scorecards."
category: hr
triggers: ["job description agent", "drafts", "calibrates job descriptions", "scorecards"]
