...
description: "Hypothesis generator: The Hypothesis generator is an AI agent that proposes testable hypotheses from evidence. Use when the task involves hypothesis generator, science, proposes testable hypotheses from evidence."
category: science
triggers: ["hypothesis generator", "science", "proposes testable hypotheses from evidence"]
