...
description: "Lease abstraction & management agent: The Lease abstraction & management agent is an AI agent that extracts lease terms and tracks obligations, renewals, and escalations. Use when the task involves lease abstraction & management agent, extracts lease terms, tracks obligations, renewals, escalations."
category: construction
triggers: ["lease abstraction & management agent", "extracts lease terms", "tracks obligations", "renewals", "escalations"]
