...
description: "Language practice agent: The Language practice agent is an AI agent that provides conversational language practice and correction. Use when the task involves language practice agent, provides conversational language practice, correction."
category: education
triggers: ["language practice agent", "provides conversational language practice", "correction"]
