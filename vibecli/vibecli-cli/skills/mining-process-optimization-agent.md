...
description: "Process optimization agent: The Process optimization agent is an AI agent that optimizes yield, energy, and quality in process plants. Use when the task involves process optimization agent, optimizes yield, quality in process plants."
category: mining
triggers: ["process optimization agent", "optimizes yield", "quality in process plants"]
