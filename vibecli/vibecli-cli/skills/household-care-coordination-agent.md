...
description: "Care coordination agent: The Care coordination agent is an AI agent that coordinates appointments, records, and caregivers. Use when the task involves care coordination agent, coordinates appointments, records, caregivers."
category: household
triggers: ["care coordination agent", "coordinates appointments", "records", "caregivers"]
