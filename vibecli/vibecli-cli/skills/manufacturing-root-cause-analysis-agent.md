...
description: "Root-cause analysis agent: The Root-cause analysis agent is an AI agent that investigates defects and proposes corrective actions. Use when the task involves root-cause analysis agent, investigates defects, proposes corrective actions."
category: manufacturing
triggers: ["root-cause analysis agent", "investigates defects", "proposes corrective actions"]
