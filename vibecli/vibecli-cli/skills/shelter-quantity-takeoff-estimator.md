...
description: "Quantity takeoff estimator: The Quantity takeoff estimator is an AI agent that produces material and cost takeoffs from drawings. Use when the task involves quantity takeoff estimator, produces material, cost takeoffs from drawings."
category: construction
triggers: ["quantity takeoff estimator", "produces material", "cost takeoffs from drawings"]
