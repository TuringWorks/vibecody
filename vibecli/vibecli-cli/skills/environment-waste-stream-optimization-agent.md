...
description: "Waste stream optimization agent: The Waste stream optimization agent is an AI agent that optimizes collection, sorting, and recycling flows. Use when the task involves waste stream optimization agent, environment, optimizes collection, sorting, recycling flows."
