---
name: "Informal Economy — Waste-picker cooperative agent"
description: "Informal Economy — Waste-picker cooperative agent: The Waste-picker cooperative agent is an AI-personnel role that organizes routes, weights, prices, and buyer connections for waste pickers and informal recyclers. Use when the task involves informal economy — waste-picker cooperative agent, waste-picker cooperative..."
category: economics
triggers: ["informal economy — waste-picker cooperative agent", "waste-picker cooperative agent"]
...
> **Shared concepts:** `jobs-to-be-done-framework` · **Why this layer:** the library's "fits any nation" premise requires roles for the informal sector, not only the formal one
