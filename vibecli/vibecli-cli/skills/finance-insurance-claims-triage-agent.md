...
description: "Insurance claims triage agent: The Insurance claims triage agent is an AI agent that classifies and routes claims and flags fraud. Use when the task involves insurance claims triage agent, classifies, routes claims, flags fraud."
category: finance
triggers: ["insurance claims triage agent", "classifies", "routes claims", "flags fraud"]
