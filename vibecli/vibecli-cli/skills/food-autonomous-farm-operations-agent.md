---
triggers: ["autonomous farm operations agent", "food", "orchestrates the whole farm cycle — plans field tasks", "sequences machinery", "robots", "tracks progress against the crop plan"]
