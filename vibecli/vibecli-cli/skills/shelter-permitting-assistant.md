...
description: "Permitting assistant: The Permitting assistant is an AI agent that guides and pre-checks permit applications against code. Use when the task involves permitting assistant, guides, pre-checks permit applications against code."
category: construction
triggers: ["permitting assistant", "guides", "pre-checks permit applications against code"]
