...
description: "Localization agent: The Localization agent is an AI agent that localizes content across languages and cultures. Use when the task involves localization agent, localizes content across languages, cultures."
category: media
triggers: ["localization agent", "localizes content across languages", "cultures"]
