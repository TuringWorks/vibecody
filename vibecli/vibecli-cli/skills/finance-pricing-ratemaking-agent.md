...
description: "Pricing & ratemaking agent: The Pricing & ratemaking agent is an AI agent that develops rate-adequacy analyses, GLM-based pricing, and rate-filing support within actuarial standards of practice. Use when the task involves pricing & ratemaking agent, develops rate-adequacy analyses, glm-based pricing, rate-filing sup..."
category: finance
triggers: ["pricing & ratemaking agent", "develops rate-adequacy analyses", "glm-based pricing", "rate-filing support within actuarial standards of practice"]
