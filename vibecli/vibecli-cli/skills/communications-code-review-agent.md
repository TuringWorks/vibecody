...
description: "Code review agent: The Code review agent is an AI agent that reviews diffs for bugs, security, and standards. Use when the task involves code review agent, reviews diffs for bugs, security, standards."
category: telecom
triggers: ["code review agent", "reviews diffs for bugs", "security", "standards"]
