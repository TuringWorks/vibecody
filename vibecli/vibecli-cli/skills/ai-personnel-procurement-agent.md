---
name: "AI Personnel Catalog — Procurement agent"
description: "AI Personnel Catalog — Procurement agent: Handles the job: compare suppliers, draft RFPs, track contract obligations. Use when the task involves ai personnel catalog — procurement agent, procurement agent."
category: agent
triggers: ["ai personnel catalog — procurement agent", "procurement agent"]
