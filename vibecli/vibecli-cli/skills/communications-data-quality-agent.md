...
description: "Data quality agent: The Data quality agent is an AI agent that detects anomalies, reconciles records, and maintains pipelines. Use when the task involves data quality agent, detects anomalies, reconciles records, maintains pipelines."
category: telecom
triggers: ["data quality agent", "detects anomalies", "reconciles records", "maintains pipelines"]
