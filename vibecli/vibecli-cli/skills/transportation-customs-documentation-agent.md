...
description: "Customs documentation agent: The Customs documentation agent is an AI agent that prepares and checks customs and trade documentation. Use when the task involves customs documentation agent, prepares, checks customs, trade documentation."
category: logistics
triggers: ["customs documentation agent", "prepares", "checks customs", "trade documentation"]
