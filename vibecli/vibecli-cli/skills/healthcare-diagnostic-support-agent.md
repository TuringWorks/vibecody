...
description: "Diagnostic support agent: The Diagnostic support agent is an AI agent that surfaces differential diagnoses and relevant evidence. Use when the task involves diagnostic support agent, surfaces differential diagnoses, relevant evidence."
category: healthcare
triggers: ["diagnostic support agent", "surfaces differential diagnoses", "relevant evidence"]
