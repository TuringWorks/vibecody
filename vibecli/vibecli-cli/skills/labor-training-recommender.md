...
description: "Training recommender: The Training recommender is an AI agent that recommends learning paths to close gaps. Use when the task involves training recommender, labor, recommends learning paths to close gaps."
category: hr
triggers: ["training recommender", "labor", "recommends learning paths to close gaps"]
