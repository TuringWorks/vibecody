...
description: "Dependency mapping agent: The Dependency mapping agent is an AI agent that maps cross-system dependencies and single points of failure. Use when the task involves dependency mapping agent, resilience, maps cross-system dependencies, single points of failure."
category: resilience
triggers: ["dependency mapping agent", "resilience", "maps cross-system dependencies", "single points of failure"]
