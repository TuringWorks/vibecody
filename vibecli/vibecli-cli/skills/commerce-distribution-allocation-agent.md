...
description: "Distribution & allocation agent: The Distribution & allocation agent is an AI agent that coordinates wholesale distribution, allocations, and backorders across the network. Use when the task involves distribution & allocation agent, coordinates wholesale distribution, allocations, backorders across the network."
category: retail
triggers: ["distribution & allocation agent", "coordinates wholesale distribution", "allocations", "backorders across the network"]
