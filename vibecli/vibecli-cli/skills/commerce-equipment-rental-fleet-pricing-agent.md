...
description: "Equipment-rental fleet & pricing agent: The Equipment-rental fleet & pricing agent is an AI agent that manages rental/leasing fleet utilization, availability, and pricing. Use when the task involves equipment-rental fleet & pricing agent, manages rental, leasing fleet utilization, availability, pricing."
category: retail
triggers: ["equipment-rental fleet & pricing agent", "manages rental", "leasing fleet utilization", "availability", "pricing"]
