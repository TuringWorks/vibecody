...
description: "Grievance & redress agent: The Grievance & redress agent is an AI agent that triages exclusion and error complaints and prepares remediation. Use when the task involves grievance & redress agent, triages exclusion, error complaints, prepares remediation."
category: identity
triggers: ["grievance & redress agent", "triages exclusion", "error complaints", "prepares remediation"]
