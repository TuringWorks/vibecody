...
description: "Census & survey operations agent: The Census & survey operations agent is an AI agent that plans enumeration, monitors coverage, and flags gaps. Use when the task involves census & survey operations agent, plans enumeration, monitors coverage, flags gaps."
category: identity
triggers: ["census & survey operations agent", "plans enumeration", "monitors coverage", "flags gaps"]
