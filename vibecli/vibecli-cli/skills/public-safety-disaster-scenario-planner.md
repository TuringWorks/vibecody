...
description: "Disaster scenario planner: The Disaster scenario planner is an AI agent that models hazard scenarios and resource needs. Use when the task involves disaster scenario planner, models hazard scenarios, resource needs."
category: public-safety
triggers: ["disaster scenario planner", "models hazard scenarios", "resource needs"]
