...
description: "OSINT analyst agent: The OSINT analyst agent is an AI agent that collects and synthesizes open-source signals into assessed intelligence drafts. Use when the task involves osint analyst agent, defense, collects."
category: defense
triggers: ["osint analyst agent", "defense", "collects"]
