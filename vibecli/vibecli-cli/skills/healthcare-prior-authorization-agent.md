...
description: "Prior authorization agent: The Prior authorization agent is an AI agent that prepares and submits prior-authorization requests. Use when the task involves prior authorization agent, prepares, submits prior-authorization requests."
category: healthcare
triggers: ["prior authorization agent", "prepares", "submits prior-authorization requests"]
