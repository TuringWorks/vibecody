...
description: "Maritime route & weather-routing agent: The Maritime route & weather-routing agent is an AI agent that plans sea routes and weather routing for vessels and monitors maritime traffic and safety. Use when the task involves maritime route & weather-routing agent, plans sea routes, weather routing for vessels, monitors..."
category: logistics
triggers: ["maritime route & weather-routing agent", "plans sea routes", "weather routing for vessels", "monitors maritime traffic", "safety"]
