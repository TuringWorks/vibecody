...
description: "Weather/yield forecast agent: The Weather/yield forecast agent is an AI agent that forecasts yield and weather risk for planning and hedging. Use when the task involves weather/yield forecast agent, weather, yield forecast agent, forecasts yield, weather risk for planning."
category: agriculture
triggers: ["weather/yield forecast agent", "weather", "yield forecast agent", "forecasts yield", "weather risk for planning", "hedging"]
