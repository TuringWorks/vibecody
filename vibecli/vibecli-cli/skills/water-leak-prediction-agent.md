...
description: "Leak prediction agent: The Leak prediction agent is an AI agent that predicts leaks and pipe failures from pressure and acoustic data. Use when the task involves leak prediction agent, predicts leaks, pipe failures from pressure, acoustic data."
category: water
triggers: ["leak prediction agent", "predicts leaks", "pipe failures from pressure", "acoustic data"]
