...
description: "Curriculum alignment checker: The Curriculum alignment checker is an AI agent that checks materials against standards and outcomes. Use when the task involves curriculum alignment checker, checks materials against standards, outcomes."
category: education
triggers: ["curriculum alignment checker", "checks materials against standards", "outcomes"]
