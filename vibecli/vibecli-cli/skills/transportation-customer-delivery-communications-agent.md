...
description: "Customer delivery communications agent: The Customer delivery communications agent is an AI agent that sends delivery status and exception updates. Use when the task involves customer delivery communications agent, sends delivery status, exception updates."
category: logistics
triggers: ["customer delivery communications agent", "sends delivery status", "exception updates"]
