...
description: "Legal discovery agent: The Legal discovery agent is an AI agent that reviews evidence, builds timelines, analyzes contracts, precedents, and filings. Use when the task involves legal discovery agent, governance, reviews evidence, builds timelines, analyzes contracts."
category: government
triggers: ["legal discovery agent", "governance", "reviews evidence", "builds timelines", "analyzes contracts", "precedents", "filings"]
