...
description: "Candidate matching assistant: The Candidate matching assistant is an AI agent that screens and matches candidates to roles. Use when the task involves candidate matching assistant, screens, matches candidates to roles."
category: hr
triggers: ["candidate matching assistant", "screens", "matches candidates to roles"]
