...
description: "HR policy assistant: The HR policy assistant is an AI agent that answers policy questions and drafts policy. Use when the task involves hr policy assistant, answers policy questions, drafts policy."
category: hr
triggers: ["hr policy assistant", "answers policy questions", "drafts policy"]
