...
description: "Incident response copilot: The Incident response copilot is an AI agent that assembles incident context and proposes response steps. Use when the task involves incident response copilot, assembles incident context, proposes response steps."
category: telecom
triggers: ["incident response copilot", "assembles incident context", "proposes response steps"]
