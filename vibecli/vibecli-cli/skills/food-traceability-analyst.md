...
description: "Traceability analyst: The Traceability analyst is an AI agent that tracks lots through the supply chain and supports recalls. Use when the task involves traceability analyst, tracks lots through the supply chain, supports recalls."
category: agriculture
triggers: ["traceability analyst", "tracks lots through the supply chain", "supports recalls"]
