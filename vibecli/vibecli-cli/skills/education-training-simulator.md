...
description: "Training simulator: The Training simulator is an AI agent that builds scenario-based practice for skills. Use when the task involves training simulator, education, builds scenario-based practice for skills."
category: education
triggers: ["training simulator", "education", "builds scenario-based practice for skills"]
