...
description: "Cyber defense agent: The Cyber defense agent is an AI agent that performs continuous monitoring and incident-response assistance. Use when the task involves cyber defense agent, performs continuous monitoring, incident-response assistance."
category: defense
triggers: ["cyber defense agent", "performs continuous monitoring", "incident-response assistance"]
