...
description: "Autonomous tractor: The Autonomous tractor is a non-humanoid autonomous machine whose job is to till, plant, cultivate, and tow implements across fields to a crop plan with no operator i. Use when the task involves autonomous tractor, food."
