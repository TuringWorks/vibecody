...
description: "Care gap analyst: The Care gap analyst is an AI agent that identifies overdue screenings and care gaps in panels. Use when the task involves care gap analyst, identifies overdue screenings, care gaps in panels."
category: healthcare
triggers: ["care gap analyst", "identifies overdue screenings", "care gaps in panels"]
