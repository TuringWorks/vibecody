...
description: "Red-team simulation agent: The Red-team simulation agent is an AI agent that models adversary options and stress-tests plans. Use when the task involves red-team simulation agent, models adversary options, stress-tests plans."
category: defense
triggers: ["red-team simulation agent", "models adversary options", "stress-tests plans"]
