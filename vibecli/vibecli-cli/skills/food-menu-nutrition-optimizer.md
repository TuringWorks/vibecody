...
description: "Menu nutrition optimizer: The Menu nutrition optimizer is an AI agent that optimizes menus for nutrition, cost, and dietary needs. Use when the task involves menu nutrition optimizer, optimizes menus for nutrition, cost, dietary needs."
category: agriculture
triggers: ["menu nutrition optimizer", "optimizes menus for nutrition", "cost", "dietary needs"]
