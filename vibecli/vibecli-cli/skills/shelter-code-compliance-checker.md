...
description: "Code compliance checker: The Code compliance checker is an AI agent that checks designs and plans against building codes. Use when the task involves code compliance checker, checks designs, plans against building codes."
category: construction
triggers: ["code compliance checker", "checks designs", "plans against building codes"]
