...
description: "Grant compliance reviewer: The Grant compliance reviewer is an AI agent that checks grant spending against terms and prepares findings. Use when the task involves grant compliance reviewer, checks grant spending against terms, prepares findings."
category: public-finance
triggers: ["grant compliance reviewer", "checks grant spending against terms", "prepares findings"]
