...
description: "Anomaly detection agent: The Anomaly detection agent is an AI agent that flags irregular transactions and patterns across revenue and spending data. Use when the task involves anomaly detection agent, flags irregular transactions, patterns across revenue, spending data."
category: public-finance
triggers: ["anomaly detection agent", "flags irregular transactions", "patterns across revenue", "spending data"]
