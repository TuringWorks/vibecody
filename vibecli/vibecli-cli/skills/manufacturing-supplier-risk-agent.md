...
description: "Supplier risk agent: The Supplier risk agent is an AI agent that monitors supplier delivery, quality, and continuity risk. Use when the task involves supplier risk agent, monitors supplier delivery, quality, continuity risk."
category: manufacturing
triggers: ["supplier risk agent", "monitors supplier delivery", "quality", "continuity risk"]
