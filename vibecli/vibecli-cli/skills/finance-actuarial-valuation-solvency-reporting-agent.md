...
description: "Actuarial valuation & solvency-reporting agent: The Actuarial valuation & solvency-reporting agent is an AI agent that prepares reserves, capital, and disclosures under IFRS 17, Solvency II, and US Stat/RBC for rev. Use when the task involves actuarial valuation & solvency-reporting agent, prepares reserves, capital..."
category: finance
triggers: ["actuarial valuation & solvency-reporting agent", "prepares reserves", "capital", "disclosures under ifrs 17", "solvency ii", "us stat", "rbc for review by the appointed actuary"]
