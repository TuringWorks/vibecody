...
description: "Pension & retirement valuation agent: The Pension & retirement valuation agent is an AI agent that performs actuarial pension valuations (funding status, PBO/ABO, contribution projections) for review by t. Use when the task involves pension & retirement valuation agent, performs actuarial pension valuations (funding..."
category: public-finance
triggers: ["pension & retirement valuation agent", "performs actuarial pension valuations (funding status", "pbo", "abo", "contribution projections) for review by the plan actuary"]
