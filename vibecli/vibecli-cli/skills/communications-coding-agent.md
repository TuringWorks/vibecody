---
name: "Coding agent"
description: "Coding agent: The Coding agent is an AI agent that builds, tests, refactors, and documents software under review. Use when the task involves coding agent, builds, tests, refactors, documents software under review."
category: telecom
triggers: ["coding agent", "builds", "tests", "refactors", "documents software under review"]
