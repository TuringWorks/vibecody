...
description: "Quality anomaly detector: The Quality anomaly detector is an AI agent that detects defects and quality drift from inspection and sensor data. Use when the task involves quality anomaly detector, detects defects, quality drift from inspection, sensor data."
category: manufacturing
triggers: ["quality anomaly detector", "detects defects", "quality drift from inspection", "sensor data"]
