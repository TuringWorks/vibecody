---
triggers: ["soil and nutrient optimization agent", "soil", "nutrient optimization agent", "food", "recommends fertilizer", "amendments", "variable-rate inputs from soil", "tissue", "yield data"]
