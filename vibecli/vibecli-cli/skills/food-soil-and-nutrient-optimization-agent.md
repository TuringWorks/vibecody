...
description: "Soil and nutrient optimization agent: The Soil and nutrient optimization agent is an AI agent that recommends fertilizer, amendments, and variable-rate inputs from soil, tissue, and yield data. Use when the task involves soil and nutrient optimization agent, soil, nutrient optimization agent, recommends fertilizer,..."
category: agriculture
triggers: ["soil and nutrient optimization agent", "soil", "nutrient optimization agent", "recommends fertilizer", "amendments", "variable-rate inputs from soil", "tissue", "yield data"]
