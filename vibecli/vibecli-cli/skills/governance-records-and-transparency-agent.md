...
description: "Records and transparency agent: The Records and transparency agent is an AI agent that indexes documents, redacts sensitive data, and prepares FOIA/records responses. Use when the task involves records and transparency agent, records, transparency agent, governance, indexes documents."
category: government
triggers: ["records and transparency agent", "records", "transparency agent", "governance", "indexes documents", "redacts sensitive data", "prepares foia", "records responses"]
