...
description: "Consent & data-exchange agent: The Consent & data-exchange agent is an AI agent that manages consent artifacts and audits data sharing against policy. Use when the task involves consent & data-exchange agent, manages consent artifacts, audits data sharing against policy."
category: identity
triggers: ["consent & data-exchange agent", "manages consent artifacts", "audits data sharing against policy"]
