...
description: "Customer outage communications agent: The Customer outage communications agent is an AI agent that drafts and targets outage and restoration updates. Use when the task involves customer outage communications agent, drafts, targets outage, restoration updates."
category: energy
triggers: ["customer outage communications agent", "drafts", "targets outage", "restoration updates"]
