...
description: "Warehouse slotting agent: The Warehouse slotting agent is an AI agent that optimizes storage slotting and pick paths. Use when the task involves warehouse slotting agent, optimizes storage slotting, pick paths."
category: logistics
triggers: ["warehouse slotting agent", "optimizes storage slotting", "pick paths"]
