...
description: "Dispatch optimizer: The Dispatch optimizer is an AI agent that allocates and routes responders against live demand. Use when the task involves dispatch optimizer, allocates, routes responders against live demand."
category: public-safety
triggers: ["dispatch optimizer", "allocates", "routes responders against live demand"]
