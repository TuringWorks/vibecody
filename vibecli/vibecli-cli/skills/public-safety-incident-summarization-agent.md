...
description: "Incident summarization agent: The Incident summarization agent is an AI agent that maintains a live common operating picture and after-action logs. Use when the task involves incident summarization agent, maintains a live common operating picture, after-action logs."
category: public-safety
triggers: ["incident summarization agent", "maintains a live common operating picture", "after-action logs"]
