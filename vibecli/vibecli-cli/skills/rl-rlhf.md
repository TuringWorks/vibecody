...
description: "RLHF & LLM Alignment: Align language models with PPO, DPO, KTO, ORPO, GRPO, reward model training, RLEF (execution feedback), and Constitutional AI. Use when the task involves RLHF, DPO, KTO, ORPO, GRPO."
category: ai
