...
description: "Fall-risk monitor: The Fall-risk monitor is an AI agent that monitors for falls and safety risks under oversight. Use when the task involves fall-risk monitor, monitors for falls, safety risks under oversight."
category: household
triggers: ["fall-risk monitor", "monitors for falls", "safety risks under oversight"]
