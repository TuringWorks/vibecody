...
description: "Simulation agent: The Simulation agent is an AI agent that runs and analyzes computational simulations. Use when the task involves simulation agent, runs, analyzes computational simulations."
category: science
triggers: ["simulation agent", "runs", "analyzes computational simulations"]
