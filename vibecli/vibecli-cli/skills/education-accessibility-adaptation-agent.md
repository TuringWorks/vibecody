...
description: "Accessibility adaptation agent: The Accessibility adaptation agent is an AI agent that adapts materials for accessibility needs. Use when the task involves accessibility adaptation agent, education, adapts materials for accessibility needs."
category: education
triggers: ["accessibility adaptation agent", "education", "adapts materials for accessibility needs"]
