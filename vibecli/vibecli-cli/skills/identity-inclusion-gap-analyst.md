...
description: "Inclusion-gap analyst: The Inclusion-gap analyst is an AI agent that finds populations missing from registries and targets outreach. Use when the task involves inclusion-gap analyst, finds populations missing from registries, targets outreach."
category: identity
triggers: ["inclusion-gap analyst", "finds populations missing from registries", "targets outreach"]
