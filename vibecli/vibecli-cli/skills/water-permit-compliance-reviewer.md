...
description: "Permit compliance reviewer: The Permit compliance reviewer is an AI agent that checks discharge and abstraction against permit limits. Use when the task involves permit compliance reviewer, checks discharge, abstraction against permit limits."
category: water
triggers: ["permit compliance reviewer", "checks discharge", "abstraction against permit limits"]
