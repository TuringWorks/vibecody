...
description: "Deduplication & fraud agent: The Deduplication & fraud agent is an AI agent that detects duplicate, ghost, and fraudulent identities. Use when the task involves deduplication & fraud agent, detects duplicate, ghost, fraudulent identities."
category: identity
triggers: ["deduplication & fraud agent", "detects duplicate", "ghost", "fraudulent identities"]
