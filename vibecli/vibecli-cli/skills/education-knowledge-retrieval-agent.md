...
description: "Knowledge retrieval agent: The Knowledge retrieval agent is an AI agent that finds, classifies, and retrieves knowledge resources. Use when the task involves knowledge retrieval agent, finds, classifies, retrieves knowledge resources."
category: education
triggers: ["knowledge retrieval agent", "finds", "classifies", "retrieves knowledge resources"]
