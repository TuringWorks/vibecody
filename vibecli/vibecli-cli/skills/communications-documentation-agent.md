...
description: "Documentation agent: The Documentation agent is an AI agent that produces and maintains technical documentation. Use when the task involves documentation agent, produces, maintains technical documentation."
category: telecom
triggers: ["documentation agent", "produces", "maintains technical documentation"]
