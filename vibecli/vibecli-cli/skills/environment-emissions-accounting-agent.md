...
description: "Emissions accounting agent: The Emissions accounting agent is an AI agent that compiles and audits greenhouse-gas inventories. Use when the task involves emissions accounting agent, environment, compiles, audits greenhouse-gas inventories."
category: sustainability
triggers: ["emissions accounting agent", "environment", "compiles", "audits greenhouse-gas inventories"]
