...
description: "Imaging triage assistant: The Imaging triage assistant is an AI agent that prioritizes and pre-reads imaging studies. Use when the task involves imaging triage assistant, prioritizes, pre-reads imaging studies."
category: healthcare
triggers: ["imaging triage assistant", "prioritizes", "pre-reads imaging studies"]
