...
description: "Emergency call triage assistant: The Emergency call triage assistant is an AI agent that classifies incoming calls, extracts location and severity, and supports dispatch. Use when the task involves emergency call triage assistant, classifies incoming calls, extracts location, severity, supports dispatch."
category: public-safety
triggers: ["emergency call triage assistant", "classifies incoming calls", "extracts location", "severity", "supports dispatch"]
