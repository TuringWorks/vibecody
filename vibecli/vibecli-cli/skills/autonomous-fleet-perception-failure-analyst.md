---
name: "Autonomous-Fleet Ops — Perception-failure analyst"
description: "Autonomous-Fleet Ops — Perception-failure analyst: The Perception-failure analyst detects and diagnoses perception failures (missed, mislabeled, or hallucinated objects) and triages them by safety impact. Use when the task involves autonomous-fleet ops — perception-failure analyst, perception-failure analyst."
category: robotics
triggers: ["autonomous-fleet ops — perception-failure analyst", "perception-failure analyst"]
...
Use it when a task calls for this work: detects and diagnoses perception failures (missed, mislabeled, or hallucinated objects) and triages them by safety impact. Pair with `autonomous-machine-*` (the platforms) and any operating-system skill (01–23) whose fleet this supports.
