...
description: "Public health surveillance agent: The Public health surveillance agent is an AI agent that monitors signals for outbreak detection. Use when the task involves public health surveillance agent, healthcare, monitors signals for outbreak detection."
category: healthcare
triggers: ["public health surveillance agent", "healthcare", "monitors signals for outbreak detection"]
