...
description: "Customer support agent: The Customer support agent is an AI agent that resolves routine requests and escalates edge cases. Use when the task involves customer support agent, resolves routine requests, escalates edge cases."
category: retail
triggers: ["customer support agent", "resolves routine requests", "escalates edge cases"]
