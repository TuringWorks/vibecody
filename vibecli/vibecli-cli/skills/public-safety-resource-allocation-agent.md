...
description: "Resource allocation agent: The Resource allocation agent is an AI agent that matches shelters, supplies, and crews to needs. Use when the task involves resource allocation agent, matches shelters, supplies, crews to needs."
category: public-safety
triggers: ["resource allocation agent", "matches shelters", "supplies", "crews to needs"]
