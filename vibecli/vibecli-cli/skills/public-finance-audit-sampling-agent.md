...
description: "Audit sampling agent: The Audit sampling agent is an AI agent that selects statistically defensible samples and assembles evidence. Use when the task involves audit sampling agent, selects statistically defensible samples, assembles evidence."
category: public-finance
triggers: ["audit sampling agent", "selects statistically defensible samples", "assembles evidence"]
