---
triggers: ["reserving & loss-development agent", "finance", "builds loss-development triangles", "ibnr estimates (chain-ladder", "bornhuetter-ferguson) for the reserving actuary"]
