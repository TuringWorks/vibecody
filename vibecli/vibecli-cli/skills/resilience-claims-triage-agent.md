...
description: "Claims triage agent: The Claims triage agent is an AI agent that triages post-disaster claims and aid requests. Use when the task involves claims triage agent, resilience, triages post-disaster claims, aid requests."
category: resilience
triggers: ["claims triage agent", "resilience", "triages post-disaster claims", "aid requests"]
