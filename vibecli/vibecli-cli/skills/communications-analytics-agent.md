...
description: "Analytics agent: The Analytics agent is an AI agent that answers data questions and builds analyses. Use when the task involves analytics agent, answers data questions, builds analyses."
category: telecom
triggers: ["analytics agent", "answers data questions", "builds analyses"]
